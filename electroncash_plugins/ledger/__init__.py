...
description = _('Provides support for Ledger hardware wallet. Open the Bitcoin Cash app on your Ledger device for proper SIGHASH_FORKID support (recommended). Bitcoin app v2.1+ has signing issues; BCH app provides native fork ID compatibility. BIP44 derivation m/44\'/512\'/0\' (SLIP-0044 Radiant). Supports app v1.x legacy (btchip) and v2.1+ modern PSBT protocol.')
